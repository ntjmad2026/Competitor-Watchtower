...
function setupPage() {
  ...
  + '<p class="hint" style="margin-top:10px">You need a Claude Pro or Team account (claude.ai). Open the Terminal app (Cmd+Space, type Terminal) and run these two lines. The first asks for your Mac password (typing is invisible — that\'s normal); the second opens a browser login, then prints your token:</p>'
